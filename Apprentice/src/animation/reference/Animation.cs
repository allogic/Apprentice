...
public sealed class Animation
{
    ...
    public void PlaySounds(IAnimationSoundSink soundsManager, TimeSpan previousDuration, TimeSpan currentDuration)
    {
    ...
    public void SpawnParticles(EntityPlayer player, IAnimationParticleSink particlesManager, TimeSpan previousDuration, TimeSpan currentDuration)
    {
